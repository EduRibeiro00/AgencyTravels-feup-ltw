<?php
    ...
    if(isset($_SESSION['userID']) && $_SESSION['userID'] != '') {
        ...
        $jsFiles = ['../js/main.js', '../js/place_page.js','../js/price_reservation.js', '../js/comments.js','../js/googleMapsMyPlace.js'];
    }
    else {
        $user_info = NULL;
        $jsFiles = ['../js/main.js', '../js/place_page.js', '../js/login.js','../js/price_reservation.js','../js/googleMapsMyPlace.js'];
    }
