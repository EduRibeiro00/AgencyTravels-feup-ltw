    ...
    <form action="column" method="post">
        ...
        <fieldset>
            ...
            <article class="row edit-house-caracteristics">
                <label>numRooms <input type="text" name="numRooms"value=" <?=get_house_numRooms($placeId)['numRooms'];?>"></label>
                <label>numBathrooms <input type="text" name="numBathrooms" value=" <?=get_house_numBathrooms($placeId)['numBathrooms'];?>"></label>
